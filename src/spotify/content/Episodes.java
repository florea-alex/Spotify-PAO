...
public class Episodes extends Commands {
    ...
    public String toString() {
        ...
        public Episodes(Episodes episodesData_) {
        this.number = episodesData_.getNumber();
        this.name = episodesData_.getName();
        this.duration = episodesData_.getduration();
        this.currentSecond = episodesData_.getCurrentSecond();
        this.currentMinute = episodesData_.getCurrentMinute();
    }
}
