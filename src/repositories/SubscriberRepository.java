        ...
        try {
            ...
            while (rs.next()) {
                Subscriber Subscriber = new Subscriber(rs.getString("firstName"),
                        ...
                        new CreditCard(rs.getString("cardEmitter"),
    ...
    public Subscriber selectSubscriberDetails(String emailAddress) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Subscriber.setCreditCard(new CreditCard(rs.getString("cardEmitter"),
                        rs.getInt("cardNumber"),
                        rs.getInt("cvv"),
                        rs.getString("ownerName"),
                        rs.getString("fullAddress")));
    ...
    public Subscriber selectSubscriber(String emailAddress, String password) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Subscriber.setCreditCard(new CreditCard(rs.getString(5), rs.getInt(6), rs.getInt(7), rs.getString(8),
                        rs.getString(9)));
